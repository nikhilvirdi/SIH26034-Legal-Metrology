...
// Inter font family — using downloadable fonts defined in res/font/
// Falls back to system sans-serif if not available
val InterFontFamily = FontFamily.Default  // Will be replaced by downloadable font

val AppTypography = Typography(
    // Display styles (used for big hero numbers — e.g., mm measurements)
